...
public class StudentThreding {

	public static void main(String[] args) {
		
		StudentThreding string= new StudentThreding();
		string.new PrintStudentThreding("Student Name is:\n Amr"," Student Email is:\n Amr@gmail.com", "Student Age is:\n 19"
	...
	public synchronized static void print(String s1, String s2, String s3, String s4, String s5, String s6) {
		...
		class PrintStudentThreding implements Runnable {
			
			Thread thread;
			String s1, s2, s3 ,s4 ,s5 ,s6;
			
		public PrintStudentThreding (String studentName, String studentEmail, String studentAge, String studentFaculty, String studentPhone,
				String studentGrade){
			...
			StudentThreding.print(s1, s2, s3, s4 ,s5 ,s6);
